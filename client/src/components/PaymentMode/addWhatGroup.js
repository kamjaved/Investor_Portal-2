                            ...
                            <div className="row justify-content-center animated fadeIn">
                                <div className="col-lg-7 col-md-10 align-item-center">
                                    <div className="bg-light border border-purple">
                                        <div>
                                            <h3 className="purple text-center p-4 text-white"><Link to="/admin/payment" className="text-white"><i className="fa fa-arrow-left mr-2 float-left"></i></Link> Add Whatsapp Group Link</h3></div>
                                        <fieldset className="p-4">
                                            ...
                                            <button type="submit" className="d-block py-3 px-5 purple border-0 rounded font-weight-bold mt-3 text-white">Add</button>
