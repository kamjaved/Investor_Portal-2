                            ...
                            <div className="row justify-content-center animated fadeIn">
                                <div className="col-lg-7 col-md-10 align-item-center">
                                    <div className="bg-light">
                                        <div>
                                            <h3 className="purple text-center text-white p-4"><Link to="/admin/payment" className="text-white"><i className="fa fa-arrow-left mr-2 float-left"></i></Link> Add UPI Detail</h3></div>
                                        <fieldset className="p-4">
                                            ...
                                            >
                                                ...
                                                <option value="" className="form-control">--Select UPI--</option>
                                                <option value="https://res.cloudinary.com/kamranjaved/image/upload/v1587197066/20200418_132851_t9kfx9.jpg">PayTM</option>
                                                <option value="https://res.cloudinary.com/kamranjaved/image/upload/v1587197066/20200418_133126_t5j87t.jpg">PhonePay</option>
                                                <option value="https://res.cloudinary.com/kamranjaved/image/upload/v1587197066/20200418_132939_uyudm7.jpg">GPay</option>
                                            </select>
                                            ...
                                            <div>
                                                <small>Upload QR Code <b>Max-File-Size-1MB <br />Supported File jpg/png</b></small>
                                                <input
                                            ...
                                            <button type="submit" className="d-block py-3 px-5 purple text-white border-0 rounded font-weight-bold mt-3">Add</button>
