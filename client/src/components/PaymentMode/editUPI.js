                            ...
                            <div className="row justify-content-center animated fadeIn">
                                <div className="col-lg-7 col-md-10 align-item-center">
                                    <div className="bg-light">
                                        <div>
                                            <h3 className="purple text-center text-white p-4"><Link to="/dashboard" className="text-white"><i className="fa fa-arrow-left mr-2 float-left"></i></Link> Edit UPI Detail</h3></div>
...
export default connect(mapStateToProps, { editUpiPay, getCurrentUpiPay, })(EditUpiPay);
