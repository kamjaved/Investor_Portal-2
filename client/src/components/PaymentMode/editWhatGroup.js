...
import { editWhatGroup, getCurrentWhatGroup } from '../../_actions/whatsGroupAction'
                            ...
                            <div className="row justify-content-center animated fadeIn">
                                <div className="col-lg-7 col-md-10 align-item-center">
                                    <div className="bg-light border border-purple">
                                        <div>
                                            <h3 className="purple text-center p-4 text-white"><Link to="/admin/payment" className="text-white"><i className="fa fa-arrow-left mr-2 float-left"></i></Link> Edit Whatsapp Group Link</h3></div>
                                        <fieldset className="p-4">

                                            <input name="groupLink"
                                            ...
                                            <button type="submit" className="d-block py-3 px-5 purple border-0 rounded font-weight-bold mt-3 text-white">Edit</button>
...
export default connect(mapStateToProps, { editWhatGroup, getCurrentWhatGroup, })(EditWhatGroup);
