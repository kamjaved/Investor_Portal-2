...
import { editGrocery, getCurrentGrocery } from '../../_actions/groceryAction'
...
const EditGrocery = ({
    ...
    useEffect(() => {
        ...
        setFormData({
            groceryKitName: loading || !grocery.groceryKitName ? "" : grocery.groceryKitName,
                            ...
                            <div className="row justify-content-center animated fadeIn">
                                <div className="col-lg-7 col-md-10 align-item-center">
                                    <div className="bg-light border border-danger">
                                        <div>
                                            <h3 className="bg-danger text-center p-4 text-white"><Link to="/dashboard" className="text-white"><i className="fa fa-arrow-left mr-2 float-left"></i></Link> Edit Grocery Kit</h3></div>
                                        <fieldset className="p-4">
                                            ...
                                            <button type="submit" className="d-block py-3 px-5 bg-danger border-0 rounded font-weight-bold mt-3 text-white">Edit</button>
...
export default connect(mapStateToProps, { editGrocery, getCurrentGrocery, })(EditGrocery);
