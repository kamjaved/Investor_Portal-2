                        ...
                        <div>
                            <div className="container-fluid mb-4 pb-4">
                                <div className="row mb-1  animated fadeIn">
                                        ...
                                        <Link to="/admin/add-grocery" style={{ textDecoration: "none" }}>
                                            <div className="card text-white bg-danger h-100">
                                                <div className="card-body bg-danger">
                                                    ...
                                                    <h3 className="text-uppercase text-white">Add Grocery Kit</h3>
                                    ...
                                    <div className="col-xl-2 col-sm-6 py-2">
                                        <Link to="/admin/view-grocery" style={{ textDecoration: "none" }}>
                                            <div className="card text-white bg-danger h-100">
                                                <div className="card-body bg-danger">
                                                    <div className="rotate">
                                                        <i className="fa fa-cutlery fa-4x"></i>
                                                    </div>
                                                    <h3 className="text-uppercase text-white">View Grocery Kit</h3>
                                        ...
                                        <Link to="/admin/payment" style={{ textDecoration: "none" }}>
                                            <div className="card text-white purple h-100">
                                                <div className="card-body purple">
                                                    ...
                                                    <h3 className="text-uppercase text-white">Add Payment Modes</h3>
                                        ...
                                        <Link to="/admin/allPayment" style={{ textDecoration: "none" }}>
                                            <div className="card text-white purple h-100">
                                                <div className="card-body purple">
                                                    ...
                                                    <h3 className="text-uppercase text-white">View Payment Mode</h3>
