...
const ViewUsersExpense = ({
    ...
    let UserSumTotal = usersSumExp.map(user => (
                        ...
                        <div className="row justify-content-center animated fadeInRight">
                            <div className="col-lg-10 col-md-10 align-item-center">
                                <div class="row">
                                    ...
                                    <div className="col-sm-6"> <h2 className="pt-2">{UserName}'s all expenses </h2></div>
                                    <div className="col-sm-4"> <Link className="btn btn-info btn-block">Total Exp: <i className="fa fa-usd"> </i> {parseFloat(UserSumTotal).toFixed(2)} </Link></div>
                                </div>
...
const mapStateToProps = state => ({
    ...
    UserName: state.expense.UserName
});
